...
INGRESS_CONTROLLER_SELECTOR="app.kubernetes.io/component=controller"                         # ingress controller selector

# VAULT
VAULT_URL="https://vault.${HOST_DOMAIN}"                                                     # vault url
...
CP_CERT_SETUP_SELECTOR="app=${CHART_NAME[8]}"                                                # container platform cert setup selector
